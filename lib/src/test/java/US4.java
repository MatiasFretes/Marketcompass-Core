...
//    private SeleccionadorPorCriterio criterioVacio = null;
//    private SeleccionadorPorCriterio criterioDistanciaCercana;
//    private SeleccionadorPorCriterio criterioDistanciaLejana;
//    private Set<SeleccionadorPorCriterio> criterios;
//
//    @BeforeEach
//    public void setup() {
...
//       criterioDistanciaCercana = (SeleccionadorPorCriterio) criterios.stream()
//    		    .filter(cls -> cls.getClass().getSimpleName().equals("DistanciaCercana"))
//    		    .findFirst()
//    		    .orElse(null);
//       
//       criterioDistanciaLejana = (SeleccionadorPorCriterio) criterios.stream()
